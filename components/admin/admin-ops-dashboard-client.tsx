  ...
  return (
    <div className="space-y-7">
      ...
      <div className="surface-subtle flex flex-wrap gap-2 p-3">
        ...
        <Button asChild size="sm" variant="outline">
          <Link href="/admin/venues">Venues (places) →</Link>
        </Button>
        <Button asChild size="sm" variant="outline">
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <SectionCard
          ...
          description="Download one plain text file per application in a tar archive for offline analysis or AI review."
        >
          <div className="space-y-3 rounded-lg border border-border/60 bg-background/40 p-3">
            <p className="text-sm text-muted-foreground">
              Export respects your current application filters, producing a separate <code>.txt</code> file for each
              matching application (UTF-8, no markdown) inside one <code>.tar</code> download.
            </p>
            <p className="text-xs text-muted-foreground">
